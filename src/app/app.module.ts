...
@NgModule({
    declarations: [AppComponent, HeaderComponent, RecipesComponent, RecipeListComponent, RecipeItemComponent, RecipeDetailComponent, RecipeStartComponent, ShoppingListComponent, ShoppingListAddComponent, DropdownDirective],
